...
class Conv4(torch.nn.Module):
    def __init__(self, flatten=True):
        ...
        self.layer1 = nn.Sequential(collections.OrderedDict([
          ('conv',    nn.Conv2d(3, 8, kernel_size=3, stride=2, padding=1, bias=False)),
          ('bn',      nn.BatchNorm2d(8)),
          ('relu',    nn.ReLU()),
        ...
        self.layer2 = nn.Sequential(collections.OrderedDict([
          ('conv',    nn.Conv2d(8, 16, kernel_size=3, stride=2, padding=1, bias=False)),
        ...
        self.layer3 = nn.Sequential(collections.OrderedDict([
          ('conv',    nn.Conv2d(16, 32, kernel_size=3, stride=4, padding=1, bias=False)),
        ...
        self.layer4 = nn.Sequential(collections.OrderedDict([
          ('conv',    nn.Conv2d(32, 64, kernel_size=3, stride=2, padding=1, bias=False)),
